...
To further analyse the potential correlation between seasons and prescribing of salbutamol inhalers
...
map_salbutamol_inhaler_per_1k <- salbutamol_inhaler_map_data %>%
  ...
  labs(title = "Salbutamol Inhaler Prescriptions per 1,000 people", subtitle = "Prescriptions by Health Board") +
  theme_void() +
