...
Salbutamol is a short-acting beta-agonist (SABA) most commonly prescribed in the treatment of asthma. 

The aim of this report is to investigate the trends regarding prescribing of salbutamol in Scotland in the year 2024. With a focus on 

It is imortant to consider the influence of these factors on the prescribing of salbutamol

Across the NHS Health Boards, we would expect 
...
salbutamol_drugs <- c("SALBUTAMOL", "AIROMIR", "ASMALAL", "SALAMOL", "SALBULIN", "VENTOLIN")

salbutamol_data <- combined_data_2024 %>% 
  filter(str_detect(bnf_item_description, paste(salbutamol_drugs, collapse = "|")))
...
```{r pressure, include=TRUE, out.width="150%"}

salbutamol_prescription_12months <- salbutamol_data %>% 
